...
import leaveManagementAutomationFramework.Selenium.*;
...
public class AllNavigation {
    ...
    public static class Login {
        public static void select() {
            leaveManagementAutomationFramework.Selenium.Driver.Instance.get(leaveManagementAutomationFramework.Selenium.Driver.baseAddress + "login.jsp");
            WebDriverWait wait = new WebDriverWait(leaveManagementAutomationFramework.Selenium.Driver.Instance, 5);
    ...
    public static class PersonalInfo {
        public static void select() {
            WebElement menuPersonalInfo = leaveManagementAutomationFramework.Selenium.Driver.Instance.findElement(By.cssSelector("a[href='mainPageMenu.do']"));
